...
pLongitudeLabel.grid(row=7, column=0, pady=10)
pLongitudeTXT.grid(row=7, column=1, pady=10)
pLatitudeLabel.grid(row=8, column=0, pady=10)
pLatitudeTXT.grid(row=8, column=1, pady=10)
